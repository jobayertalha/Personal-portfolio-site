            ...
            <div className="grid gap-8 lg:grid-cols-2 max-w-6xl mx-auto">
              {[
                ...
                },
                {
                  ...
                  tags: ["NLP", "Transformers", "BanglaBERT", "PyTorch", "Kaggle", "Deep Learning"],
                  icon: Brain,
                  features: [
        ...
        <section id="activities" className="py-24 bg-white/50 dark:bg-slate-900/50">
          <div className="container px-4 md:px-6">
            <div className="max-w-2xl mx-auto text-center mb-16">
              ...
              <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 dark:text-white mb-4">Extra Activities</h2>
              <p className="text-lg text-slate-600 dark:text-slate-400">
                Leadership and community engagement beyond formal work experience
              </p>
            </div>
                    ...
                    <div className="flex items-start justify-between flex-wrap gap-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <div>
                            <CardTitle className="text-slate-900 dark:text-white">{activity.title}</CardTitle>
                            <CardDescription className="text-slate-600 dark:text-slate-400 font-medium">
                              {activity.company}
                            </CardDescription>
                          </div>
